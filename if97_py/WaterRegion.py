...
if __name__ == '__main__':
    water = WaterRegion()
    print(water.enthalpy_t_p(300, 3))   # 115.33127302143839  0.115 331 273 × 10^3
    print(water.enthalpy_t_p(300, [80]))  # 184.14282773425  0.184 142 828 × 10^3
    print(water.enthalpy_t_p([500], [3]))   # 975.54223909723  0.975 542 239 × 10^3
