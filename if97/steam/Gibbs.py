...
nr = (
    -0.0017731742473212999, -0.017834862292357999, -
...
def get_γr_π(π, τ):
    result = 0.0
    for i in range(43):
        result += nr[i] * Ir[i] * π ** (Ir[i] - 1) * (τ - 0.5) ** Jr[i]
    return result
